...
void cadastrar(cardapio *p)
{
    ...
    printf("Qual a descri��o do card�pio\n");
...
{
    printf("Digite o nome do item que ir� atualizar\n");
    ...
    if (encontrado)
    {
        printf("Item encontrado! O que quer alterar?\n");
        {
            ...
            case 3:
                ...
                break;
            case 4:
                printf("Informe o novo pre�o do pedido\n");
...
int main()
{
    ...
    int p;
    printf("Ol�, esse � o sistema de gerenciamento do seu restaruante!\nDigite:\n");
    while (1)
    {
